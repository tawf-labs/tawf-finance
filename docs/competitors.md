# How tawf.finance compares to Securitize

This page frames Tawf Finance against the best known tokenized securities
platform, [securitize.io](https://securitize.io/), for judges and partners.

## Short version

Securitize and Tawf Finance are in different leagues and different segments,
not direct competitors.

- Securitize tokenizes large private securities for accredited and
  institutional investors.
- Tawf Finance tokenizes small trade finance deals for the retail long tail,
  starting at 10 USDC.

They both put real world assets on a blockchain. They solve opposite ends of
the market.
...
| Underwriting | Issuer or asset manager | Local cooperative verifies the purchase order and anchor buyer |
| KYC | Full institutional KYC and AML | Reusable web3 identity via didit.me |

## Positioning

Securitize is institutional tokenized securities infrastructure. It makes
...
trade finance for everyone else.

## Why the difference matters

- Access: Securitize opens private markets to the wealthy. Tawf opens real
  economy funding to anyone with a phone and a wallet.
- Risk model: Securitize relies on issuer diligence and market liquidity.
